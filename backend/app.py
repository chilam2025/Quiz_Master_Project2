...
# 3. Submit quiz answers and get score
...
if __name__ == "__main__":
    with app.app_context():
        ...
        # TEMPORARY: Check how many questions are in quiz 1
        questions = Question.query.filter_by(quiz_id=1).all()
        print(f"Quiz 1 has {len(questions)} questions in the database")
